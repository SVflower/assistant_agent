...
| D11 | **十个文件越过行数软线** | `agent/context.py`(342)、`agent/loop.py`(466)、`agent/recovery.py`(471)、`cli/setup.py`(449)、`config/schema.py`(352)、`main.py`(328)、`mcp/manager.py`(386)、`obs/logger.py`(361)、`tools/base.py`(337)、`tools/registry.py`(379) | 🟢 | 全部低于硬线 500；M14 将进程、控制和 Workspace 放入独立 `runtime/`，未继续扩张 Loop；Loop/Recovery 已接近硬线 | Loop/Recovery 新增职责前必须先拆；`mcp/manager.py` 增加健康/重连职责时先拆 discovery/policy；禁止放宽硬线 |
